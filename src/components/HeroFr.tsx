    ...
    <section className="relative min-h-screen bg-gradient-to-br from-primary-50 via-white to-accent-50 overflow-hidden">
      ...
      <div className="container mx-auto px-4 pt-8 pb-16 relative">
        ...
        <div className="flex items-center justify-center mb-12 animate-fade-in">
          <img 
            src="/lovable-uploads/logo_fr.webp" 
        ...
        <div className="flex justify-center items-center gap-8 mb-12 animate-fade-in" style={{animationDelay: '0.2s'}}>
          <div className="flex items-center gap-2 text-primary-600">
            ...
            <span className="text-sm font-medium">+5.000 mères satisfaites</span>
          </div>
          <div className="flex items-center gap-2 text-primary-600">
            <Shield className="w-5 h-5" />
            <span className="text-sm font-medium">Garantie de 7 jours</span>
          </div>
          <div className="flex items-center gap-2 text-primary-600">
            <Users className="w-5 h-5" />
            <span className="text-sm font-medium">Approuvé par des spécialistes</span>
          </div>
        </div>
          ...
          <div className="text-center lg:text-left space-y-8 animate-fade-in w-full max-w-[95vw] sm:max-w-xl mx-auto" style={{animationDelay: '0.4s'}}>
            <div className="space-y-6">
              <h1 className="text-5xl lg:text-7xl font-bold leading-tight break-words">
                <span className="text-gray-800">Fatiguée des</span>
...
Nous avons la <span className="text-accent-600">solution</span>.
                </span>
              </h1>
              
              <p className="text-xl text-gray-600 leading-relaxed max-w-full lg:max-w-none break-words">
                Découvrez la méthode qui a déjà transformé la vie de <strong className="text-primary-600">milliers de mamans</strong> et 
                profitez enfin des nuits paisibles que vous méritez.
              </p>
            </div>
            ...
            <div className="flex items-center justify-center lg:justify-start gap-1 pt-4">
              <div className="flex -space-x-2">
                <img src="/lovable-uploads/mae3.webp.png" alt="Cliente" className="w-10 h-10 rounded-full border-2 border-white object-cover" loading="lazy"/>
                <img src="/lovable-uploads/mae1.webp" alt="Cliente" className="w-10 h-10 rounded-full border-2 border-white object-cover" loading="lazy"/>
                <img src="/lovable-uploads/mae2.webp.png" alt="Cliente" className="w-10 h-10 rounded-full border-2 border-white object-cover" loading="lazy"/>
              </div>
              <div className="ml-3">
                <div className="flex">
                  {[...Array(5)].map((_, i) => (
                ...
                <p className="text-sm text-gray-600">Plus de 5 000 avis 5 étoiles</p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="absolute -top-4 -right-4 bg-white rounded-full p-3 shadow-lg animate-float">
                <div className="text-center">
                  ...
                  <div className="text-xs text-gray-600">Numérique</div>
                </div>
              </div>
